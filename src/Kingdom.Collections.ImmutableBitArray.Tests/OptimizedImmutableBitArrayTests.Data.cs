            ...
            get
            {
                IEnumerable<object[]> GetAll()
                {
                    ...
                    IEnumerable<uint> GetValues(int count)
                    {
                        while (count-- > 0)
                        {
                            foreach (var x in InternalRandomValues)
                            {
                                yield return x;
                            }
                        }
        ...
        public static IEnumerable<object[]> BinaryAndData
        {
            get
            {
                IEnumerable<object[]> GetAll()
                {
                    ...
                    foreach (var x in RandomIntValuesAttribute.InternalRandomValues)
                    {
                        foreach (var y in RandomIntValuesAttribute.InternalRandomValues)
                        {
