...
namespace Kingdom.Collections
{
    ...
    public partial class OptimizedImmutableBitArrayTests : SubjectTestFixtureBase<OptimizedImmutableBitArray>
    {
        public OptimizedImmutableBitArrayTests(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
        }
        ...
        /// <see cref="OptimizedImmutableBitArray.Equals(OptimizedImmutableBitArray)"/>
        /// <see cref="Equals(OptimizedImmutableBitArray, OptimizedImmutableBitArray)"/>
        ...
        public void Equals_calculation_is_correct(IEnumerable<uint> x, IEnumerable<uint> y, bool expected)
        {
            ...
            Assert.False(OptimizedImmutableBitArray.Equals(a, null));
            Assert.False(OptimizedImmutableBitArray.Equals(b, null));
            Assert.False(OptimizedImmutableBitArray.Equals(null, a));
            Assert.False(OptimizedImmutableBitArray.Equals(null, b));
            Assert.Equal(expected, a.Equals(b));
            Assert.Equal(expected, b.Equals(a));
            Assert.Equal(expected, OptimizedImmutableBitArray.Equals(a, b));
            Assert.Equal(expected, OptimizedImmutableBitArray.Equals(b, a));
        }
        ...
        /// <see cref="OptimizedImmutableBitArray.CompareTo(OptimizedImmutableBitArray)"/> code by
        /// those test cases.
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="expected"></param>
        /// <see cref="OptimizedImmutableBitArray.CompareTo(OptimizedImmutableBitArray)"/>
        /// <see cref="CompareTo(OptimizedImmutableBitArray, OptimizedImmutableBitArray)"/>
